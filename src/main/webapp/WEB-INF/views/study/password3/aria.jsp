...
<div class="container">
  ...
  <p>
  	...
  	ARIA가 사용하는 대부분의 연산은 XOR과 같은 단순한 바이트단위연산으로 구성되어 있으며, 블록크기는 <font color="red">128bit</font>이다.<br/>
  	ARIA라는 이름은 Academy(학계), Research Institute(연구소), Agency(정부기관)의 첫 글자를 딴 것으로,
