			...
			$.ajax({
				...
				success:function(vo){
					...
					if(vo != ''){
						...
						str += '<font color="red"><b>찾는 자료가 없음</b></font>';
					}
					$("#demo").html(str);
				},
				error : function(){
...
<div class="container">
  ...
  <h2>AJax를 활용한 '회원 아이디' 검색하기</h2>
  	...
  	<p>아이디
  		...
  		<input type="button" value="아이디 일치검색" onclick="idCheck()" class="btn btn-secondary"/>&nbsp;
  		<input type="button" value="아이디 일부검색" onclick="idList()" class="btn btn-secondary"/>&nbsp;
