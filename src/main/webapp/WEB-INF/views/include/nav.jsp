  ...
  <div class="w3-bar w3-black w3-card">
    ...
    <div class="w3-dropdown-hover w3-hide-small">
      ...
      <div class="w3-dropdown-content w3-bar-block w3-card-4">
        ...
        <a href="${ctp}/study/password3/aria" class="w3-bar-item w3-button">암호화연습3(ARIA)</a>
        <a href="${ctp}/study/password3/securityCheck" class="w3-bar-item w3-button">암호화연습3(Security)</a>
    ...
    <div class="w3-dropdown-hover w3-hide-small">
      ...
      <div class="w3-dropdown-content w3-bar-block w3-card-4">
        ...
        <a href="${ctp}/member/memUpdate" class="w3-bar-item w3-button">회원정보수정</a>
