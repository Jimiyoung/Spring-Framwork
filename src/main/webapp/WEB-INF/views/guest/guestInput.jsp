...
<div class="container">
  <form name="myForm" method="post" class="was-validated">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" name="email" id="email" placeholder="E-mail 입력하세요." />
      <div class="invalid-feedback">E-mail 선택 입력사항입니다.</div>
    </div>
    <div class="form-group">
      <label for="homepage">Homepage</label>
      <input type="text" class="form-control" name="homepage" id="homepage" value="http://" />
      <div class="invalid-feedback">Homepage 선택 입력사항입니다.</div>
    </div>
    ...
    <div class="form-group">
	    <button type="submit" class="btn btn-secondary" onclick="fCheck()">방명록 등록</button> &nbsp;
