/*대분류*/
create table goods1(
	product1 varchar(50) not null primary key /*대분류 명*/
);
...
/*중분류*/
create table goods2(
	product1 varchar(50) not null, /*대분류 명*/
	product2 varchar(50) not null primary key, /*중분류 명*/
	foreign key(product1) references goods1(product1)
--	on update casecade on delete restrict
);
...
create table goods3(
	...
	product1 varchar(50) not null, /*대분류 명*/
	product2 varchar(50) not null, /*중분류 명*/
	product3 varchar(50) not null, /*소분류 명*/
	foreign key(product1) references goods1(product1),
